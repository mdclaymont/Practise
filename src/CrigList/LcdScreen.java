...
public class LcdScreen {
	...
	public static void main(String[] args) {
		...
		public static void setRun() {
			...
			driver.findElement(By.xpath("//input[@name='PostingTitle']")).sendKeys("iPhone Lcd Screen Replacement - $50");
			driver.findElement(By.xpath("//input[@name='postal']")).sendKeys("19703");
			driver.findElement(By.xpath("//*[@name='PostingBody']")).sendKeys("We have new LCD screen for All iPhone. price is $60 And Bellow  including the labor cost. please call me Thank you");
